    ...
    RPP l = new RPP() {
    	RPP l = new RPP() {
    				...
    				RPP l = new RPP() {
    					RPP l = new RPP() {
    						RPP l = new RPP() {
    							...
    							RPP r = new RPP() {
    								RPP function = new yarel_lang_cantor_boundedminimization.InvMinH12();
    		...
    		RPP r = new RPP() {
    			RPP l = new RPP() {
    				RPP l = new RPP() {
    					RPP function = new yarel_lang_cantor_funcH12.InvH12_v2();
    					private final int a = function.getA();
    					public int[] b(int[] x) { 
    						  	return this.function.b(x);
    					}
    	...
    	RPP r = new RPP() {
    		RPP l = new RPP() {
    			RPP l = new RPP() {
    				RPP l = new RPP() {
    					RPP function = new yarel_lang_arithmetics_nat.InvSub();
    					private final int a = function.getA();
    					public int[] b(int[] x) { 
    						  	return this.function.b(x);
    					}
