...
import yarel_lang_cantor_funcH12.*
import yarel_lang_cantor_boundedminimization.*
module yarel_lang_cantor_pairing {
   ...
   */
    ...
    /* End of bugfix */ 
            ...
            ; yarel_lang_arithmetics_nat.sub|id|id|id    /* v*-1-(z-Sum[v*-1])   z-Sum[v*-1]  0 0 0 */
			; /2 1 3 4 5/
