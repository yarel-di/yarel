 ...
 * <ul>
 * <li> {@link RPP}</li>
* <li> {@link bitStack.Bitpush}</li>
* <li> {@link bitStack.Bitpop}</li>
 * </ul>
 * <p>
 *
 * NOTE:<br>
...
public class BitStackPlayWith {
	...
	public static void testBitpush(){
		RPP bitpushRPP = new bitStack.Bitpush();
		final int[][] datasets = {
			new int[]{1,2,3,4,5},
			new int[]{4,3,2,1,5},
			new int[]{ 0,  0,  0,  0,  0},
		...
		for( int[] data: datasets ){
			System.out.println("\nTesting the function bitpush with values:" + Arrays.toString(data));
			bitpushRPP.b(data);
	...
	public static void testBitpop(){
		RPP bitpopRPP = new bitStack.Bitpop();
		final int[][] datasets = {
			new int[]{1,2,3,4,5},
			new int[]{4,3,2,1,5},
			new int[]{ 0,  0,  0,  0,  0},
		...
		for( int[] data: datasets ){
			System.out.println("\nTesting the function bitpop with values:" + Arrays.toString(data));
			bitpopRPP.b(data);
			System.out.println("Resulting in: " + Arrays.toString(data));
		}
	}
