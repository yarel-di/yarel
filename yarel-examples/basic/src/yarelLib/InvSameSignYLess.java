...
public class InvSameSignYLess implements RPP {
	public InvSameSignYLess(//arities:
		int M
		,
		int K,
		int P,
	...
	public SameSignYLess getInverse(){
		return new SameSignYLess(this.M,K, P, Q);
	}
