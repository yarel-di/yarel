...
public class InvSameSignYMore implements RPP {
	public InvSameSignYMore(//arities:
		int M
		,
		int K,
		int P,
	...
	public SameSignYMore getInverse(){
		return new SameSignYMore(this.M,K, P, Q);
	}
