 ...
 * <ul>
 * <li> {@link RPP}</li>
* <li> {@link cantorPairing.Cp}</li>
* <li> {@link cantorPairing.Cu}</li>
 * </ul>
 * <p>
 *
 * NOTE:<br>
...
public class CantorPairingPlayWith {
	...
	public static void testCp(){
		...
		for( BigInteger[] data: datasets ){
			System.out.println("\nTesting the function cp with values:" + Arrays.toString(data));
			cpRPP.b(data);
	...
	public static void testCu(){
		...
		for( BigInteger[] data: datasets ){
			System.out.println("\nTesting the function cu with values:" + Arrays.toString(data));
			cuRPP.b(data);
			System.out.println("Resulting in: " + Arrays.toString(data));
		}
	}
