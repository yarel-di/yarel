...
public class InvShiftFirstToLastK_OLD implements RPP {
	public InvShiftFirstToLastK_OLD(//arities:
		int K
		){
	...
	protected InvShiftFirstToLastK_OLD(){
		this(1);
	}
	...
	*/
	...
	public ShiftFirstToLastK_OLD getInverse(){
		return new ShiftFirstToLastK_OLD(this.K);
	}
