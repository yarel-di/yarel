...
public class InvDecIncrDouble implements RPP {
	public InvDecIncrDouble(//arities:
		int K
		,
		int Amount1,
		int Amount2
	...
	protected InvDecIncrDouble(){
		this(1,0, 0);
	}
	
	protected final int __fixedRegistersAmount__;
	protected final int K;
	protected final int Amount1;
	...
	public int getAmount1(){ return this.Amount1; }
	
	public int getAmount2(){ return this.Amount2; }
	...
	*/
	...
	protected void finalize(){
		this.destructorDecIncrDouble();
	}
	protected void destructorDecIncrDouble(){
	...
	public DecIncrDouble getInverse(){
		return new DecIncrDouble(this.K,Amount1, Amount2);
	}
