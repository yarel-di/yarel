...
public class MultipleParArities implements RPP {
	public MultipleParArities(//arities:
	...
	*/
	...
	public InvMultipleParArities getInverse(){
		return new InvMultipleParArities(this.IncrAr, this.NegAr,IncrAmount, NegAmount);
	}
