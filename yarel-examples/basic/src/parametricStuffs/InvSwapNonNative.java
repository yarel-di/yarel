...
public class InvSwapNonNative implements RPP {
	public InvSwapNonNative(//arities:
		int K
		,
		int S,
		int E
	...
	public SwapNonNative getInverse(){
		return new SwapNonNative(this.K,S, E);
	}
