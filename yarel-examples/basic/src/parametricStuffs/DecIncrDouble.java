...
public class DecIncrDouble implements RPP {
	public DecIncrDouble(//arities:
		int K
		,
		int Amount1,
		int Amount2
	...
	*/
	...
	public InvDecIncrDouble getInverse(){
		return new InvDecIncrDouble(this.K,Amount1, Amount2);
	}
