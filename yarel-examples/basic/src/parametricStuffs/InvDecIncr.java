...
public class InvDecIncr implements RPP {
	public InvDecIncr(
		int Amount
		){
	...
	*/
	...
	protected void finalize(){
		this.destructorDecIncr();
	}
	protected void destructorDecIncr(){
	...
	public DecIncr getInverse(){
		return new DecIncr(Amount);
	}
