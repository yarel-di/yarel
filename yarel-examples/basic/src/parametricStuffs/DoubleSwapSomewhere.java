...
public class DoubleSwapSomewhere implements RPP {
	...
	*/
	...
	public InvDoubleSwapSomewhere getInverse(){
		return new InvDoubleSwapSomewhere(this.a, this.B);
	}
