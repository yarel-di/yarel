...
public class InvPInd_dataset implements RPP {
	public InvPInd_dataset() { }
	/**
	...
	*/
	...
	protected void finalize(){
		this.destructorPInd_dataset();
	}
	protected void destructorPInd_dataset(){
	...
	public PInd_dataset getInverse(){
		return new PInd_dataset();
	}
	...
	*/
	...
	private final int[] startIndexOffsets = { 1,2,3 };
