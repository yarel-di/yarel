...
public class ShiftLastToFirst5 implements RPP {
	...
	*/
	...
	protected void finalize(){
		this.destructorShiftLastToFirst5();
	}
	protected void destructorShiftLastToFirst5(){
	...
	public InvShiftLastToFirst5 getInverse(){
		return new InvShiftLastToFirst5();
	}
	...
	private final RPP[] steps = new RPP[]{
		new RPP() { // ParCompImpl
			...
			*/
			...
			private final int[] startIndexOffsets = { 0,5 };
			...
			RPP function = new RPP() { // SerCompImpl
				private final RPP[] steps = new RPP[]{
					new RPP() { // BodyPermIndexImpl
						private final int permutArity = 5;
