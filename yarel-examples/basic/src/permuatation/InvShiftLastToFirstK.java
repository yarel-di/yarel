...
public class InvShiftLastToFirstK implements RPP {
	public InvShiftLastToFirstK() { }
	/**
	...
	*/
	...
	protected void finalize(){
		this.destructorShiftLastToFirstK();
	}
	protected void destructorShiftLastToFirstK(){
	...
	public ShiftLastToFirstK getInverse(){
		return new ShiftLastToFirstK();
	}
	...
	private final RPP[] steps = new RPP[]{
		new RPP() { // ParCompImpl
			...
			*/
			...
			private final int[] startIndexOffsets = { 0,0 };
			...
			RPP function = new RPP() { // SerCompImpl
				private final RPP[] steps = new RPP[]{
					new RPP() { // BodyPermIndexImpl
						private final int permutArity = 0;
