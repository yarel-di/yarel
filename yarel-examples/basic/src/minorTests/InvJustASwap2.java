...
public class InvJustASwap2 implements RPP {
	public InvJustASwap2(//arities:
		int K
		,
		int I
		){
	...
	public JustASwap2 getInverse(){
		return new JustASwap2(this.K,I);
	}
