...
public class InvParamItInc implements RPP {
	public InvParamItInc(//arities:
		int K
		,
		int Amount
		){
	...
	public ParamItInc getInverse(){
		return new ParamItInc(this.K,Amount);
	}
