...
public class SwapSRLLike2 implements RPP {
	public SwapSRLLike2(//arities:
		int K
		,
		int I,
		int J
		...
		// constraint bound
		if( 1 > J || J >= K ){ throw new IllegalArgumentException("The parameter J should be greater than zero and lower than K"); }
	}
	protected SwapSRLLike2(){
		this(1,0, 0);
	}
	...
	public InvSwapSRLLike2 getInverse(){
		return new InvSwapSRLLike2(this.K,I, J);
	}
