...
public class TriIncPar implements RPP {
	public TriIncPar() { }
	...
	*/
	...
	protected void finalize(){
		this.destructorTriIncPar();
	}
	protected void destructorTriIncPar(){
	...
	public InvTriIncPar getInverse(){
		return new InvTriIncPar();
	}
