...
public class SomeAtomicStuffs implements RPP {
	public SomeAtomicStuffs() { }
	...
	*/
	...
	public InvSomeAtomicStuffs getInverse(){
		return new InvSomeAtomicStuffs();
	}
