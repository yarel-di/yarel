...
public class InvWastingSomeID implements RPP {
	public InvWastingSomeID() { }
	...
	*/
	...
	protected void finalize(){
		this.destructorWastingSomeID();
	}
	protected void destructorWastingSomeID(){
	...
	public WastingSomeID getInverse(){
		return new WastingSomeID();
	}
