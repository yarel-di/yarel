...
import bubble4Fili.B4sort_p1;

public class Test_B4F_Part1 extends Test_B4F_General {
//	@BeforeClass
	public static void instantiateBubble4Sorter_Part1() {
		bubble4FiliSection = new B4sort_p1();
	}
...
//		b = new Test_B4F_Part1();
		...
		System.out.println("START Test_B4F_Part1");
		Test_B4F_General.providerB4FInts().forEach(
				// b::testB4Sort
				Test_B4F_Part1::testB4Manual);
		System.out.println("END Test_B4F_Part1");
	}
