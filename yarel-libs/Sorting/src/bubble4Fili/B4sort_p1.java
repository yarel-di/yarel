...
public class B4sort_p1 implements RPP {
	public B4sort_p1() { }
	
	public InvB4sort_p1 getInverse(){
		return new InvB4sort_p1();
	}
	...
	RPP l = new RPP() { // SerCompImpl
				...
				RPP l = new RPP() { // SerCompImpl
					RPP l = new RPP() { // SerCompImpl
						...
						RPP r = new RPP() { // ParCompImpl
							private RPP f = new RPP(){
								RPP function = new integerCompare.Less();
								private final int a = function.getA();
								public void b(int[] x, int startIndex, int endIndex) {
									this.function.b(x, startIndex, endIndex);
								}
		...
		RPP r = new RPP() { // ParCompImpl
			private RPP f = new RPP(){
				RPP function = new cantorPairing.Cp();
				private final int a = function.getA();
				public void b(int[] x, int startIndex, int endIndex) {
					this.function.b(x, startIndex, endIndex);
				}
			...
			public int getA() { return this.a; }
			public void b(int[] x, int startIndex, int endIndex) {
				this.f.b(x, startIndex + 7, startIndex + this.a + 7);
			}
		};
		private final int a = l.getA();
		public int getA() { return this.a; }
