...
public class InvCompareThan implements RPP {
	public InvCompareThan(//arities:
		int M
		,
		int I,
		int J,
	...
	public CompareThan getInverse(){
		return new CompareThan(this.M,I, J, P, Q, K);
	}
