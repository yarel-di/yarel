...
public class SameSignYLess implements RPP {
	public SameSignYLess(//arities:
		int M
		,
		int K,
		int P,
	...
	public InvSameSignYLess getInverse(){
		return new InvSameSignYLess(this.M,K, P, Q);
	}
