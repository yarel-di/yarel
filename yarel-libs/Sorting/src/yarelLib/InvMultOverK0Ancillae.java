...
public class InvMultOverK0Ancillae implements RPP {
	public InvMultOverK0Ancillae(//arities:
		int M
		,
		int K,
		int J,
	...
	protected InvMultOverK0Ancillae(){
		this(1,0, 0, 0);
	}
	...
	public MultOverK0Ancillae getInverse(){
		return new MultOverK0Ancillae(this.M,K, J, I);
	}
