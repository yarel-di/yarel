...
public class MoreThan implements RPP {
	public MoreThan(//arities:
		int M
		,
		int I,
		int J,
	...
	public InvMoreThan getInverse(){
		return new InvMoreThan(this.M,I, J, P, Q, K);
	}
		...
		if(this.__theWholeBody__ == null){
			this.__theWholeBody__ = new RPP(){
				private final RPP[] __steps__ = new RPP[]{
					new RPP() { // BodyFunImpl
						RPP __function__ = new PreparationLessMore(
							0 + (1*M)
							,
							0 + (1*I),
							0 + (1*J),
