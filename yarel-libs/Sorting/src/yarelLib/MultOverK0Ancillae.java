...
public class MultOverK0Ancillae implements RPP {
	public MultOverK0Ancillae(//arities:
		int M
		,
		int K,
		int J,
	...
	public InvMultOverK0Ancillae getInverse(){
		return new InvMultOverK0Ancillae(this.M,K, J, I);
	}
