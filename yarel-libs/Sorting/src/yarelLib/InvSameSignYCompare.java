...
public class InvSameSignYCompare implements RPP {
	public InvSameSignYCompare(//arities:
		int M
		,
		int K,
		int P,
	...
	public SameSignYCompare getInverse(){
		return new SameSignYCompare(this.M,K, P, Q);
	}
