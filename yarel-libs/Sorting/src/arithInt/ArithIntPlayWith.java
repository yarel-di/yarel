 ...
 * <ul>
 * <li> {@link RPP}</li>
* <li> {@link arithInt.Sum}</li>
* <li> {@link arithInt.Sub}</li>
 * </ul>
 * <p>
 *
 * NOTE:<br>
...
public class ArithIntPlayWith {
	...
	public static void testSum(){
		...
		for( int[] data: datasets ){
			System.out.println("\nTesting the function sum with values:" + Arrays.toString(data));
			sumRPP.b(data);
	...
	public static void testSub(){
		...
		for( int[] data: datasets ){
			System.out.println("\nTesting the function sub with values:" + Arrays.toString(data));
			subRPP.b(data);
			System.out.println("Resulting in: " + Arrays.toString(data));
		}
	}
