...
public class SortUngrowingOpt implements RPP {
	public SortUngrowingOpt(//arities:
		int K
		){
	...
	*/
	...
	public InvSortUngrowingOpt getInverse(){
		return new InvSortUngrowingOpt(this.K);
	}
												...
												*/
												private final RPP[] __subtasks__ = new RPP[]{ //
													new RPP(){ // BodyFunImpl // index: 0
														RPP __function__ = new bitStack.Bitpush();
														public int getA() { return __function__.getA(); }
														public void b(int[] __x__, int __startIndex__, int __endIndex__) {
															this.__function__.b(__x__, __startIndex__, __endIndex__);
														}
