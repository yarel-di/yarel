...
public class InvSortGrowing implements RPP {
	public InvSortGrowing(//arities:
		int K
		){
	...
	*/
	...
	public SortGrowing getInverse(){
		return new SortGrowing(this.K);
	}
