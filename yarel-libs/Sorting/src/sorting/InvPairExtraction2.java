...
public class InvPairExtraction2 implements RPP {
	public InvPairExtraction2(//arities:
		int K
		){
	...
	public PairExtraction2 getInverse(){
		return new PairExtraction2(this.K);
	}
