...
public class InvSortGrowingOpt implements RPP {
	public InvSortGrowingOpt(//arities:
		int K
		){
	...
	*/
	...
	protected void finalize(){
		this.destructorSortGrowingOpt();
	}
	protected void destructorSortGrowingOpt(){
	...
	public SortGrowingOpt getInverse(){
		return new SortGrowingOpt(this.K);
	}
