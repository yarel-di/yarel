...
public class SortGrowingOpt implements RPP {
	public SortGrowingOpt(//arities:
		int K
		){
	...
	*/
	...
	public InvSortGrowingOpt getInverse(){
		return new InvSortGrowingOpt(this.K);
	}
