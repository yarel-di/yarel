...
public class InvSortUngrowingOpt implements RPP {
	public InvSortUngrowingOpt(//arities:
		int K
		){
		this.__fixedRegistersAmount__ = 9;
		if(K < 0){ throw new WrongArityException("The arity \"K\" cannot be negative: " + K); }
		this.K = K;
	}
	protected InvSortUngrowingOpt(){
		this(1);
	}
	...
	*/
	...
	protected void finalize(){
		this.destructorSortUngrowingOpt();
	}
	protected void destructorSortUngrowingOpt(){
	...
	public SortUngrowingOpt getInverse(){
		return new SortUngrowingOpt(this.K);
	}
			...
			this.__theWholeBody__ = new RPP(){
				private final RPP[] __steps__ = new RPP[]{ //
					...
					new RPP() { // ParCompImpl // index: 1
						...
						public void b(int[] __x__, int __startIndex__, int __endIndex__) {
							this.__f__.b(__x__,
								__startIndex__ + 6 + (1*K),
								__startIndex__ + (6 + (1*K)) + this.__f__.getA()
								);
						}
					},
						...
						RPP __function__ = new RPP() { // SerCompImpl
							private final RPP[] __steps__ = new RPP[]{ //
								new RPP() { // BodyItImpl // index: 0
									...
									RPP __function__ = new RPP() { // SerCompImpl
										private final RPP[] __steps__ = new RPP[]{ //
											new RPP() { // ParCompImpl // index: 0
												private RPP __f__ = new RPP(){
													RPP __function__ = new InvPairExtraction2(
														0 + (1*K)
													);
											...
											new RPP() { // ParCompImpl // index: 1
												private RPP __f__ = new RPP(){
													...
													public void b(int[] __x__, int __startIndex__, int __endIndex__) {
														...
														__x__[__startIndex__ + 6] = __x__[__startIndex__ + 2]; 
											...
											new RPP() { // ParCompImpl // index: 6
												private RPP __f__ = new RPP(){
													RPP __function__ = new PairExtraction2(
														0 + (1*K)
													);
													public int getA() { return __function__.getA(); }
													public void b(int[] __x__, int __startIndex__, int __endIndex__) {
												...
												*/
												private final RPP[] __subtasks__ = new RPP[]{ //
													new RPP(){ // BodyFunImpl // index: 0
														RPP __function__ = new bitStack.InvBitpush();
														public int getA() { return __function__.getA(); }
														public void b(int[] __x__, int __startIndex__, int __endIndex__) {
															this.__function__.b(__x__, __startIndex__, __endIndex__);
														}
								...
								new RPP() { // ParCompImpl // index: 1
									...
									public int getA() { return 8 + (1*K); }
									public void b(int[] __x__, int __startIndex__, int __endIndex__) {
										this.__f__.b(__x__,
											__startIndex__ + 4 + (1*K),
											__startIndex__ + (4 + (1*K)) + this.__f__.getA()
											);
									}
								},
					...
					new RPP() { // ParCompImpl // index: 4
						...
						*/
						private final RPP[] __subtasks__ = new RPP[]{ //
							...
							new RPP(){ // BodyParamDecImpl // index: 3
								private RPP __f__ = InvDec.SINGLETON_InvDec;
								public int getA() { return 1; }
								public void b(int[] __x__, int __startIndex__, int __endIndex__) {
									int __arity__;
