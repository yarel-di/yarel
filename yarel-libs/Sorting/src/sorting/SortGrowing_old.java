...
public class SortGrowing_old implements RPP {
	public SortGrowing_old(//arities:
		int K
		){
	...
	*/
	...
	protected void finalize(){
		this.destructorSortGrowing_old();
	}
	protected void destructorSortGrowing_old(){
	...
	public InvSortGrowing_old getInverse(){
		return new InvSortGrowing_old(this.K);
	}
								...
								new RPP() { // BodyItImpl // index: 0
									...
									RPP __function__ = new RPP() { // SerCompImpl
										private final RPP[] __steps__ = new RPP[]{
											...
											new RPP() { // ParCompImpl // index: 1
												private RPP __f__ = new RPP(){
													private final RPP[] __steps__ = new RPP[]{
														...
														new RPP() { // BodyParamPermImpl // index: 2
															public int getA() { return 1 + 3 + (1*K); }
															public void b(int[] __x__, int __startIndex__, int __endIndex__) {
																final int __permutArity__ = this.getA() - 1;
																int __tmp__ = __x__[__startIndex__], __indexToWithdraw__;
														...
														new RPP() { // BodyParamPermImpl // index: 6
															public int getA() { return 1 + 3 + (1*K); }
															public void b(int[] __x__, int __startIndex__, int __endIndex__) {
																final int __permutArity__ = this.getA() - 1;
																int __tmp__ = __x__[__startIndex__], __indexToWithdraw__;
											...
											new RPP() { // ParCompImpl // index: 2
												private RPP __f__ = new RPP(){
													...
													public void b(int[] __x__, int __startIndex__, int __endIndex__) {
														...
														__x__[__startIndex__ + 3] = __x__[__startIndex__ + 7]; 
														__x__[__startIndex__ + 7] = __x__[__startIndex__ + 4]; 
														__x__[__startIndex__ + 4] = __x__[__startIndex__ + 8]; 
														__x__[__startIndex__ + 8] = __x__[__startIndex__ + 5]; 
											...
											new RPP() { // ParCompImpl // index: 5
												private RPP __f__ = new RPP(){
													public int getA() { return 1 + 5 + (1*K); }
													public void b(int[] __x__, int __startIndex__, int __endIndex__) {
														final int __permutArity__ = this.getA() - 1;
														int __tmp__ = __x__[__startIndex__], __indexToWithdraw__;
														__indexToWithdraw__ = __x__[__startIndex__ + __permutArity__];
											...
											new RPP() { // ParCompImpl // index: 6
												private RPP __f__ = new RPP(){
													public int getA() { return 1 + 6 + (1*K); }
													public void b(int[] __x__, int __startIndex__, int __endIndex__) {
														final int __permutArity__ = this.getA() - 1;
														int __tmp__ = __x__[__startIndex__], __indexToWithdraw__;
														__indexToWithdraw__ = __x__[__startIndex__ + __permutArity__];
