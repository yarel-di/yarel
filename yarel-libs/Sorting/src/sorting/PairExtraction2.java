...
public class PairExtraction2 implements RPP {
	public PairExtraction2(//arities:
		int K
		){
	...
	public InvPairExtraction2 getInverse(){
		return new InvPairExtraction2(this.K);
	}
