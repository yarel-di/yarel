...
public class InvSortGrowing_old implements RPP {
	public InvSortGrowing_old(//arities:
		int K
		){
	...
	*/
	...
	public SortGrowing_old getInverse(){
		return new SortGrowing_old(this.K);
	}
											...
											new RPP() { // ParCompImpl // index: 2
												private RPP __f__ = new RPP(){
													...
													public void b(int[] __x__, int __startIndex__, int __endIndex__) {
														...
														__x__[__startIndex__ + 8] = __x__[__startIndex__ + 4]; 
														__x__[__startIndex__ + 4] = __x__[__startIndex__ + 7]; 
														__x__[__startIndex__ + 7] = __x__[__startIndex__ + 3]; 
