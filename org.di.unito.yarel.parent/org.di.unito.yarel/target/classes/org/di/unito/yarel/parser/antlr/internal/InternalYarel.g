	...
	(
		...
		(
			(
				(
					{
						newCompositeNode(grammarAccess.getDeclarationAccess().getTypesTypeParserRuleCall_3_0_0());
					}
			...
			(
				otherlv_4=','
				{
					newLeafNode(otherlv_4, grammarAccess.getDeclarationAccess().getCommaKeyword_3_1_0());
				}
				(
					(
						{
							newCompositeNode(grammarAccess.getDeclarationAccess().getTypesTypeParserRuleCall_3_1_1_0());
						}
...
@after {
	...
	(
		(
			...
			{
				newCompositeNode(grammarAccess.getFunctionInvocationAccess().getFunNameDeclarationCrossReference_0());
			}
			ruleQualifiedName
			{
				afterParserOrEnumRuleCall();
